        ...
        MouseArea {
            ...
            onPositionChanged:  {
                if(pressed) {
                    ...
                    if((separator1.x + offsetX) >= separator1.minX  &&
                            (separator1.x + offsetX) <= separator1.maxX)
        ...
        MouseArea {
            ...
            onPositionChanged:  {
                if(pressed) {
                    ...
                    if((separator2.y + offsetY) >= separator2.minY  &&
                            (separator2.y + offsetY) <= separator2.maxY)
